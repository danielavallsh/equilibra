...
const mealOptions:Record<string,Meal[]> = {
 breakfast:[
  {id:"breakfast-toast",type:"Desayuno",name:"Tostada con tomate, cottage y pavo",kcal:365,protein:27,prep:"Tuesta el pan, añade tomate, cottage y pavo. Acompaña con café y leche.",ingredients:[{name:"Pan integral",qty:70,unit:"g",price:.32},{name:"Tomate",qty:100,unit:"g",price:.28},{name:"Queso cottage",qty:80,unit:"g",price:.72},{name:"Pavo loncheado",qty:50,unit:"g",price:.85},{name:"Leche semidesnatada",qty:150,unit:"ml",price:.16},{name:"Café",qty:1,unit:"taza",price:.18}]},
  {id:"breakfast-yogurt",type:"Desayuno",name:"Bol de yogur, avena y fruta",kcal:390,protein:25,prep:"Mezcla el yogur con avena y fruta. Añade canela al gusto.",ingredients:[{name:"Yogur griego natural",qty:250,unit:"g",price:1.1},{name:"Copos de avena",qty:45,unit:"g",price:.12},{name:"Plátano",qty:1,unit:"ud",price:.32},{name:"Almendras",qty:10,unit:"g",price:.2}]}
 ],
 lunch:[
  {id:"lunch-chicken",type:"Comida",name:"Pollo mediterráneo con arroz",kcal:585,protein:45,prep:"Cuece el arroz. Saltea pollo y verduras con el aceite medido y mezcla.",ingredients:[{name:"Pechuga de pollo",qty:150,unit:"g",price:1.35},{name:"Arroz",qty:70,unit:"g",price:.16},{name:"Calabacín",qty:120,unit:"g",price:.24},{name:"Pimiento rojo",qty:80,unit:"g",price:.25},{name:"Aceite de oliva",qty:10,unit:"ml",price:.09}]},
  {id:"lunch-lentils",type:"Comida",name:"Ensalada templada de lentejas y huevo",kcal:560,protein:32,prep:"Mezcla las lentejas escurridas con verduras salteadas y huevo cocido.",ingredients:[{name:"Lentejas cocidas",qty:250,unit:"g",price:.85},{name:"Huevos",qty:2,unit:"ud",price:.5},{name:"Tomate",qty:120,unit:"g",price:.34},{name:"Espinacas",qty:80,unit:"g",price:.6},{name:"Aceite de oliva",qty:10,unit:"ml",price:.09}]},
  {id:"lunch-salmon",type:"Comida",name:"Salmón con patata y ensalada",kcal:610,protein:39,prep:"Hornea el salmón y la patata. Sirve con ensalada y limón.",ingredients:[{name:"Salmón",qty:150,unit:"g",price:2.8},{name:"Patatas",qty:250,unit:"g",price:.38},{name:"Mezcla de ensalada",qty:100,unit:"g",price:.75},{name:"Aceite de oliva",qty:8,unit:"ml",price:.08}]}
 ],
 dinner:[
  {id:"dinner-omelette",type:"Cena",name:"Crema de calabacín y tortilla",kcal:430,protein:28,prep:"Cuece y tritura la crema. Prepara la tortilla con huevos y claras.",ingredients:[{name:"Calabacín",qty:300,unit:"g",price:.6},{name:"Patatas",qty:100,unit:"g",price:.15},{name:"Cebolla",qty:60,unit:"g",price:.1},{name:"Huevos",qty:2,unit:"ud",price:.5},{name:"Claras",qty:100,unit:"ml",price:.55},{name:"Aceite de oliva",qty:5,unit:"ml",price:.05}]},
  {id:"dinner-wrap",type:"Cena",name:"Wrap integral de pollo y verduras",kcal:455,protein:35,prep:"Saltea el pollo y las verduras. Rellena y tuesta el wrap.",ingredients:[{name:"Tortilla integral",qty:1,unit:"ud",price:.35},{name:"Pechuga de pollo",qty:110,unit:"g",price:.99},{name:"Pimiento rojo",qty:60,unit:"g",price:.19},{name:"Cebolla",qty:40,unit:"g",price:.07},{name:"Yogur natural",qty:50,unit:"g",price:.18}]},
  {id:"dinner-hake",type:"Cena",name:"Merluza con verduras al horno",kcal:420,protein:38,prep:"Hornea la merluza y las verduras 20 minutos con limón y especias.",ingredients:[{name:"Merluza",qty:180,unit:"g",price:2.1},{name:"Calabacín",qty:180,unit:"g",price:.36},{name:"Tomate",qty:120,unit:"g",price:.34},{name:"Patatas",qty:150,unit:"g",price:.23},{name:"Aceite de oliva",qty:8,unit:"ml",price:.08}]}
 ]
};
mealOptions.snack=[
 {id:"snack-yogurt",type:"Merienda",name:"Yogur con fruta",kcal:210,protein:15,prep:"Sirve el yogur con la fruta troceada.",ingredients:[{name:"Yogur griego natural",qty:150,unit:"g",price:.66},{name:"Plátano",qty:1,unit:"ud",price:.32}]},
 {id:"snack-toast",type:"Merienda",name:"Tostada de cottage y pavo",kcal:240,protein:20,prep:"Tuesta el pan y añade cottage y pavo.",ingredients:[{name:"Pan integral",qty:40,unit:"g",price:.18},{name:"Queso cottage",qty:50,unit:"g",price:.45},{name:"Pavo loncheado",qty:40,unit:"g",price:.68}]},
 {id:"snack-alpro",type:"Merienda",name:"Alpro lima-limón con arándanos",kcal:125,protein:5,prep:"Mezcla el yogur con los arándanos y deja reposar cinco minutos.",ingredients:[{name:"Alpro lima-limón",qty:100,unit:"g",price:.48},{name:"Arándanos congelados",qty:35,unit:"g",price:.28}]}
];
mealOptions.breakfast.unshift({id:"breakfast-fixed",type:"Desayuno",name:"Tostada de centeno con tomate, cottage y pavo",kcal:205,protein:18,prep:"Prepara la tostada con tomate, cottage y pavo. Acompaña con café y leche.",ingredients:[{name:"Pan de centeno",qty:40,unit:"g",price:.18},{name:"Tomate",qty:40,unit:"g",price:.11},{name:"Queso cottage",qty:30,unit:"g",price:.27},{name:"Pavo loncheado",qty:35,unit:"g",price:.60},{name:"Leche desnatada",qty:100,unit:"ml",price:.11},{name:"Café",qty:1,unit:"taza",price:.18}]});
mealOptions.lunch.push(
 {id:"lunch-chickpea-tuna",type:"Comida",name:"Ensalada fría de garbanzos con atún",kcal:510,protein:32,prep:"Escurre los garbanzos y mezcla con verduras, atún, limón y aceite medido.",ingredients:[{name:"Garbanzos cocidos",qty:180,unit:"g",price:.48},{name:"Tomate",qty:80,unit:"g",price:.22},{name:"Pimiento",qty:40,unit:"g",price:.13},{name:"Zanahoria",qty:40,unit:"g",price:.08},{name:"Atún en lata",qty:50,unit:"g",price:.72},{name:"Aceite de oliva",qty:5,unit:"ml",price:.05}]},
 {id:"lunch-chicken-broccoli",type:"Comida",name:"Pollo con brócoli y patata",kcal:535,protein:45,prep:"Haz el pollo a la plancha, el brócoli al vapor y la patata cocida o asada.",ingredients:[{name:"Pechuga de pollo",qty:150,unit:"g",price:1.35},{name:"Brócoli",qty:200,unit:"g",price:.52},{name:"Patatas",qty:200,unit:"g",price:.30},{name:"Aceite de oliva",qty:5,unit:"ml",price:.05}]},
 {id:"lunch-lentil-cold",type:"Comida",name:"Ensalada fría de lentejas y huevo",kcal:490,protein:27,prep:"Escurre las lentejas y mezcla en frío con verduras, huevo duro y aceite.",ingredients:[{name:"Lentejas cocidas",qty:180,unit:"g",price:.42},{name:"Tomate",qty:70,unit:"g",price:.20},{name:"Pimiento",qty:40,unit:"g",price:.13},{name:"Zanahoria",qty:40,unit:"g",price:.08},{name:"Huevos",qty:1,unit:"ud",price:.25},{name:"Aceite de oliva",qty:3,unit:"ml",price:.03}]},
 {id:"lunch-chicken-courgette",type:"Comida",name:"Pollo con calabacín, zanahoria y patata",kcal:560,protein:43,prep:"Cocina el pollo a la plancha y las verduras salteadas o al vapor.",ingredients:[{name:"Pechuga de pollo",qty:150,unit:"g",price:1.35},{name:"Calabacín",qty:150,unit:"g",price:.30},{name:"Zanahoria",qty:50,unit:"g",price:.10},{name:"Patatas",qty:250,unit:"g",price:.38},{name:"Aceite de oliva",qty:4,unit:"ml",price:.04}]}
);
mealOptions.dinner.push(
 {id:"dinner-tuna-egg",type:"Cena",name:"Ensalada de tomate con atún y huevo",kcal:405,protein:34,prep:"Mezcla tomate, huevo duro y atún; aliña con limón o vinagre.",ingredients:[{name:"Tomate",qty:140,unit:"g",price:.39},{name:"Huevos",qty:1,unit:"ud",price:.25},{name:"Atún en lata",qty:60,unit:"g",price:.86},{name:"Aceite de oliva",qty:5,unit:"ml",price:.05}]},
 {id:"dinner-hake-vegetables",type:"Cena",name:"Merluza con menestra y patata",kcal:455,protein:40,prep:"Cocina la merluza a la plancha u horno y cuece menestra y patata.",ingredients:[{name:"Merluza congelada",qty:180,unit:"g",price:1.65},{name:"Menestra congelada",qty:200,unit:"g",price:.42},{name:"Patatas",qty:150,unit:"g",price:.23},{name:"Aceite de oliva",qty:5,unit:"ml",price:.05}]},
 {id:"dinner-asparagus",type:"Cena",name:"Tortilla de espárragos con tomate y patata",kcal:440,protein:25,prep:"Cuece o asa la patata y prepara la tortilla con poco aceite.",ingredients:[{name:"Huevos",qty:2,unit:"ud",price:.50},{name:"Espárragos",qty:50,unit:"g",price:.42},{name:"Patatas",qty:100,unit:"g",price:.15},{name:"Tomate",qty:100,unit:"g",price:.28},{name:"Aceite de oliva",qty:3,unit:"ml",price:.03}]}
);
mealOptions.dessert=[
 {id:"dessert-fruit",type:"Postre",name:"Manzana",kcal:80,protein:0,prep:"Lava y sirve la fruta.",ingredients:[{name:"Manzanas",qty:1,unit:"ud",price:.35}]},
 {id:"dessert-yogurt",type:"Postre",name:"Yogur natural",kcal:95,protein:6,prep:"Servir frío.",ingredients:[{name:"Yogur natural",qty:125,unit:"g",price:.28}]},
 {id:"dessert-cottage",type:"Postre",name:"Cottage con arándanos",kcal:145,protein:13,prep:"Mezcla y sirve.",ingredients:[{name:"Queso cottage",qty:100,unit:"g",price:.90},{name:"Arándanos congelados",qty:35,unit:"g",price:.28}]}
];

const strengthA:Exercise[]=[
 {name:"Sentadilla en multipower",sets:3,reps:"8–10",unit:"kg",defaultWeight:30,instructions:"Pies algo adelantados, rodillas en línea con los pies y espalda neutra. Baja sin dolor y empuja el suelo."},
 {name:"Peso muerto rumano",sets:3,reps:"10",unit:"kg",defaultWeight:22,instructions:"Lleva la cadera atrás con rodillas suaves. Mantén la carga cerca del cuerpo y la espalda neutra."},
 {name:"Remo sentado",sets:3,reps:"10–12",unit:"kg",defaultWeight:25,instructions:"Pecho estable, hombros lejos de las orejas. Lleva los codos atrás sin balancearte."},
 {name:"Press de pecho",sets:3,reps:"8–10",unit:"kg",defaultWeight:17.5,instructions:"Escápulas apoyadas y muñecas neutras. Baja con control y no bloquees los codos."},
 {name:"Hip thrust",sets:3,reps:"10",unit:"kg",defaultWeight:40,instructions:"Barbilla recogida, pelvis neutra y pausa arriba apretando glúteos sin arquear la espalda."}
];
const strengthB:Exercise[]=[
 {name:"Prensa inclinada",sets:3,reps:"10–12",unit:"kg",defaultWeight:55,instructions:"Apoya toda la espalda y coloca los pies a una anchura cómoda. No bloquees las rodillas."},
 {name:"Jalón al pecho",sets:3,reps:"10–12",unit:"kg",defaultWeight:25,instructions:"Baja la barra hacia la parte alta del pecho llevando los codos abajo, sin tirar con impulso."},
 {name:"Zancada atrás",sets:3,reps:"8 por lado",unit:"kg",defaultWeight:8,instructions:"Da un paso atrás y mantén estable la rodilla delantera. Empuja con el pie delantero."},
 {name:"Press de hombro",sets:3,reps:"10",unit:"kg",defaultWeight:10,instructions:"Costillas controladas y hombros bajos. Empuja arriba sin arquear la zona lumbar."},
 {name:"Plancha",sets:3,reps:"30–45 s",unit:"s",defaultWeight:30,instructions:"Contrae abdomen y glúteos manteniendo una línea recta. Para si pierdes la postura."}
];
const bodyPump:Exercise[]=[
 {name:"Calentamiento",sets:1,reps:"1 canción",unit:"kg",defaultWeight:5,instructions:"Anota el peso total de discos, sin contar la barra."},
 {name:"Sentadillas",sets:1,reps:"1 canción",unit:"kg",defaultWeight:10,instructions:"Usa un peso que permita mantener la técnica durante toda la canción."},
 {name:"Pecho",sets:1,reps:"1 canción",unit:"kg",defaultWeight:7.5,instructions:"Registra el peso total colocado en la barra."},
 {name:"Espalda",sets:1,reps:"1 canción",unit:"kg",defaultWeight:10,instructions:"Mantén espalda neutra en remos y cargadas."},
 {name:"Tríceps",sets:1,reps:"1 canción",unit:"kg",defaultWeight:5,instructions:"Anota el peso utilizado, aunque combines barra y disco."},
 {name:"Bíceps",sets:1,reps:"1 canción",unit:"kg",defaultWeight:5,instructions:"Evita balancearte para terminar las repeticiones."},
 {name:"Zancadas",sets:1,reps:"1 canción",unit:"kg",defaultWeight:7.5,instructions:"Reduce peso si afecta a la estabilidad o a la rodilla."},
 {name:"Hombros",sets:1,reps:"1 canción",unit:"kg",defaultWeight:5,instructions:"Registra el peso principal utilizado en la canción."}
];
const workouts:Record<string,Workout>={pump:{id:"pump",name:"BodyPump",kind:"pump",duration:60,exercises:bodyPump},strengthA:{id:"strengthA",name:"Fuerza A",kind:"strength",duration:50,exercises:strengthA},strengthB:{id:"strengthB",name:"Fuerza B",kind:"strength",duration:45,exercises:strengthB},rest:{id:"rest",name:"Descanso activo",kind:"rest",duration:20,exercises:[]}};
const schedule=["pump","rest","strengthA","rest","pump","strengthB","rest"];
...
export default function App(){
 ...
 useEffect(()=>{localStorage.setItem("equilibra-v2",JSON.stringify(data));document.documentElement.dataset.theme=data.settings.dark?"dark":"light"},[data]);
 const update=(patch:Partial<AppData>)=>setData(d=>({...d,...patch})); const notify=(s:string)=>{setToast(s);window.setTimeout(()=>setToast(""),2200)};
...
<button className="avatar" onClick={()=>setView("ajustes")} aria-label="Abrir ajustes">{data.settings.name.slice(0,2).toUpperCase()||"EQ"}</button>
   ...
   {view==="entreno"&&<Training data={data} update={update} notify={notify}/>}
   {view==="progreso"&&<Progress data={data} update={update}/>}
   {view==="ajustes"&&<SettingsPage data={data} update={update} notify={notify}/>}
  </main>{editing&&<DayMealEditor date={editing.date} slot={editing.slot} data={data} update={update} close={()=>setEditing(null)}/>} {toast&&<div className="toast" role="status">{toast}</div>}
 </div>
}
